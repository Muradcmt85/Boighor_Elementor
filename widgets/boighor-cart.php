...
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		...
		<tbody>
			...
			<tr>
				<td colspan="6" class="actions cartbox__btn">

					<?php if ( wc_coupons_enabled() ) { ?>
					
                        <ul class="cart__btn__list d-flex flex-wrap flex-md-nowrap flex-lg-nowrap justify-content-between">
                        <li><a href="#"><label for="coupon_code"><?php esc_html_e( 'Coupon Code', 'woocommerce' ); ?></label></a></li>
					...
					<?php wp_nonce_field( 'woocommerce-cart', 'woocommerce-cart-nonce' ); ?> </ul>
				</td>
			</tr>
...
<div class="cart-collaterals cartbox__total__area">
